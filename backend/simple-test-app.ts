...
async function createSimpleTestApp() {
  ...
  const config = new DocumentBuilder()
    .setTitle('Dealco AI Backend API - Simple Test')
    .setDescription('Simple test backend for Dealco AI - mobile price comparison app')
    .setVersion('1.0.0')
    .addBearerAuth()
  ...
  Logger.log(`🚀 Dealco AI Simple Test Backend is running on: http://localhost:${port}/${apiPrefix}`);
