...
describe('PriceEngineService', () => {
  ...
  describe('getPriceEngineStats', () => {
    it('should return price engine statistics', async () => {
      (mockProductRepository as any).count = jest.fn().mockResolvedValue(100);
      (mockRetailerRepository as any).count = jest.fn().mockResolvedValue(10);
      (mockPriceRepository as any).count = jest.fn().mockResolvedValue(1000);
